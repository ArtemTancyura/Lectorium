...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\LoginType' => function () {
    return ${($_ = isset($this->services['App\Form\LoginType']) ? $this->services['App\Form\LoginType'] : $this->services['App\Form\LoginType'] = new \App\Form\LoginType()) && false ?: '_'};
}, 'App\\Form\\RegistrationType' => function () {
    return ${($_ = isset($this->services['App\Form\RegistrationType']) ? $this->services['App\Form\RegistrationType'] : $this->services['App\Form\RegistrationType'] = new \App\Form\RegistrationType()) && false ?: '_'};
