...
class srcDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = array(
            ...
            'app\\form\\logintype' => 'App\\Form\\LoginType',
            'app\\form\\registrationtype' => 'App\\Form\\RegistrationType',
            'app\\services\\articleservice' => 'App\\Services\\ArticleService',
        ...
        $this->fileMap = array(
            ...
            'App\\Form\\LoginType' => 'getLoginTypeService.php',
            'App\\Form\\RegistrationType' => 'getRegistrationTypeService.php',
            'App\\Services\\ArticleService' => 'getArticleServiceService.php',
            ...
            'monolog.logger.lock' => 'getMonolog_Logger_LockService.php',
            ...
            'service_locator.yprcmff' => 'getServiceLocator_YprcmffService.php',
        ...
        $this->privates = array(
            ...
            'App\\Services\\ArticleService' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Syq4tFl6cK', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JfmVHUu+UC', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kzyzdnt0Cn', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ONkfmRCpLJ', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
